...
// themselves.
func (r *sessionTurnRunner) sessionTurnMu(sessionID string) *sync.Mutex {
...
func (r *sessionTurnRunner) clientTurnActive(sessionID string) bool {
...
func (r *sessionTurnRunner) markClientTurn(sessionID string, active bool) {
...
// the catch-up pass).
func (r *sessionTurnRunner) currentSessionID() string {
	r.sessMu.Lock()
...
func (r *sessionTurnRunner) fireDueAutomations(ctx context.Context) {
	if r.schedule == nil {
		return
	}
...
func (r *sessionTurnRunner) runAutomationTurn(ctx context.Context, sessionID string, a *sched.Automation, note string) {
	if note == "" {
...
func (r *sessionTurnRunner) runCatchUpOnce(ctx context.Context, sessionID string) {
	if r.schedule == nil {
		return
	}
...
// session close chain).
func (r *sessionTurnRunner) startSessionForwarder(sessionID string) (func(), bool) {
	if r.emitFor == nil {
