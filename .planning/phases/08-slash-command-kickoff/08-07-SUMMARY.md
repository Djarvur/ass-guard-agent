...
4. The fixable-recovery probe showed the same shape: Skill works (real openspec-archive-change skill content returned), Bash does not; the model interleaved 12 Skill + 15 Bash attempts — again adaptation, not blindness.
