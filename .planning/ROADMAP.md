...
**Plans:** 6/6 planned (2026-08-19)
Plans:
**Wave 1**

- [ ] 14-01-PLAN.md — shadow-git checkpoints + undo: snapshot at parent-turn entry into `.ass-guard/checkpoints/shadow.git` (external git, isolated env, never the user's .git), `ass-guard checkpoint list|restore`, the invariant battery, the gated live rollback demonstration (THE phase tracer) [EARLY-01]
...
| 14. Adoption Readiness (Analysis Dispositions) | v1.1 | 0/6 (planned 2026-08-19; dispatches alongside 12-01/02 execution) | Not started | - |
