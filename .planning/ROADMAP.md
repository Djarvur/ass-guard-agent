...
**Plans:** TBD — dispatch `/gsd:plan-phase 14` (ground truth in-repo: the two analysis docs + cline shadow-git / opencode `/undo` / LangGraph checkpointer as design references; the existing boundary/turn machinery is the snapshot hook point).
