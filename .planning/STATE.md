...
**Current focus:** Phase 0 (not started)
...
| Phase | Status | Notes |
|-------|--------|-------|
| 0 — Spike + Re-verification | Context gathered | Closes 5 STACK Phase-0 research flags; verification only (no REQ-IDs). Context: spikes/ throwaway + VERIFIED-FACTS.md + #4 structurally moot. |
